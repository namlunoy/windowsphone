...
namespace FotorEffect
{
    ...
    public sealed partial class ImagePage : Page
    {
       ...
       // GoogleAds.AdView adsView = new GoogleAds.AdView();
       // GoogleAds.InterstitialAd billboard;
        public ImagePage()
        {
            ...
            //billboard = new GoogleAds.InterstitialAd("ca-app-pub-6921176146936171/1882461045");
            //billboard.ReceivedAd += billboard_ReceivedAd;
            //GoogleAds.AdRequest request = new GoogleAds.AdRequest();
            //billboard.LoadAd(request);

        }

        //private void billboard_ReceivedAd(object sender, GoogleAds.AdEventArgs e)
        //{
        //   // billboard.ShowAd();
        //}
